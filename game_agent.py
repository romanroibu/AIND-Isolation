...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf")):
        ...
        **********************************************************************
        ...
        value, move = self._alphabeta(game, depth, alpha, beta, True)
    ...
    def _alphabeta(self, game, depth, alpha, beta, maximizing_player):
        ...
        for next_move in legal_moves:
            ...
            # Compute opponent's score for each next move
            next_value, _  = self._alphabeta(next_game, depth-1, alpha, beta, not maximizing_player)
            ...
            if maximizing_player:
                ...
                # If player is maximizing,
                # And beta value is lower that best score,
                # Cut-off the search with best score and move
                if beta <= value :
                    return value, move
                ...
                # If player is minimizing,
                # And alpha value is higher that best score,
                # Cut-off the search with best score and move
                if alpha >= value:
                    return value, move
